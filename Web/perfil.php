...
<body>
    ...
    <div class="w3-container w3-center" style="margin-left:20%;">
        <div class="w3-card perfil" style="padding:10px;width:80%;margin:10%;">
            ...
            <p style="font-size:20px;margin-top:-15px;"><?php echo $_SESSION['nombres'] . " ".$_SESSION['apellidos'] ?></p>
            ...
            <?php
                if($_SESSION['tipo'] == 1){
                    echo '<h4 class="w3-text" style="text-shadow:.5px .5px 0;">Semestre</h4><p style="font-size:20px;margin-top:-15px;">'.$_SESSION['semestre'].'</p>';
                }
            ?>
            <p></p>
